...
function addChannel(msg, args) {
    ...
    if (!name) return Invalid(msg, `No name`, `I need a name in order to create a new voice channel`, `addvoice [name]`);
    ...
    .addFields(
        { name: "A new voice channel has been created", value: `\`\`\`${name}\`\`\``},
